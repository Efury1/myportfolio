    ...
    <main>
        ...
        <section className="text-center p-10">
          ...
          <p className="text-md py-51 leading-8 text-white-800 text-center">Eliza is a coding enthusiast with a passion for turning everyday hobbies into exciting digital adventures! 
            By day, Eliza is a dedicated programmer, helping with software solutions. 
            ...
            <div className="w-full lg:w-6/12 px-4 ">
              <div className="flex flex-wrap items-top mb-6">
                ...
                <ul className="list-unstyled">
                  ...
                  <Link href="/page2" className="block uppercase text-sm font-semibold mb-2 text-right lg:text-right text-white">
                      Coming soon
                  </Link>
